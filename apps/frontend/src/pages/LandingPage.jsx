  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
      ...
      <main className="flex flex-col lg:flex-row">
        ...
        {/* 좌측: 텍스트 & 설명 영역 */}
        <div className="flex-1 flex flex-col justify-center lg:justify-start lg:pt-32 px-6 lg:px-16 py-12 bg-white dark:bg-gray-900 z-10">
          <div className="max-w-xl mx-auto lg:mx-0">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold leading-[1.2] tracking-tight text-gray-900 dark:text-white mb-6">
              기존에 경험하지 못한<br />
              새로운 여행 플래너
            </h1>
            ...
            <button 
              onClick={goLogin}
              className="bg-black dark:bg-white text-white dark:text-gray-900 px-10 py-4 text-lg font-semibold rounded-sm hover:bg-gray-800 dark:hover:bg-gray-200 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              TripMind로 시작하기
            </button>
          </div>
        ...
        {/* 우측: 기능 영역 */}
        <div className="flex-1 bg-gray-50 dark:bg-gray-800 p-6 lg:p-12 flex items-center justify-center relative overflow-hidden">
          ...
          <div className="bg-white dark:bg-gray-900 w-full max-w-2xl rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col max-h-[800px] relative z-10">
            
            <div className="p-6 border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-900 sticky top-0 z-20">
              <div className="text-center mb-4">
                <h3 className="text-lg font-bold text-gray-800 dark:text-white">어디로 여행을 떠나시나요?</h3>
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">AI에게 가고 싶은 곳과 일정을 말해주세요</p>
              </div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full pl-12 pr-14 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-black dark:focus:ring-blue-500 focus:border-transparent outline-none resize-none h-24 text-sm transition-all placeholder:text-gray-400 dark:text-white dark:placeholder-gray-500"
                />
                <button
                  ...
                  className={`absolute right-3 bottom-3 p-2 rounded-lg transition-colors ${
                    loading || !prompt.trim() 
                      ...
                      : 'bg-black dark:bg-blue-600 text-white hover:bg-gray-800 dark:hover:bg-blue-700'
                  }`}
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {destinations.map((dest, idx) => (
                  <div 
                    ...
                    className="group cursor-pointer bg-white dark:bg-gray-700 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-600 relative aspect-[3/4]"
                  >
                    <img 
                      src={dest.image} 
                      alt={dest.name} 
